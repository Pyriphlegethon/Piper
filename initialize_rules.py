...
#kernel.add_rule(SubstitutionRule(Function('Not', Sequence([Function('Or', Sequence([BoundPattern('a', Blank()), BoundPattern('b', Blank())]))])), Function('And', Sequence([Function('Not', Sequence([Symbol('a')])), Function('Not', Sequence([Symbol('b')]))]))))
